...
---
## 🚀 Live Production App
The complete frontend dashboard (React/Vite) connected to the live FastAPI backend is fully deployed and accessible here:

👉 **[Launch RailMind Dashboard](https://rail-mind-rho.vercel.app)**
---
